...
?>
  ...
  <div id="m">
    <form id="form" action="c3.php" method="post" enctype="multipart/form-data">
    <div id="tb" style="text-align: center;">
    <p><input type="text" placeholder="title" id="ti" name="t"></p>
   </div>
   <div id="bt">
     <p><input type="hidden" name="o" value="<?= $_GET['vw'];?>">
     <p><textarea placeholder="description" id="ta" name="d" rows="30" cols="30"></textarea></p>
