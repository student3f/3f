...
<html>
 <head>
  ...
  <body>
    <div id="main"><h1><a href="body.php"><img src="4.png" class="nmv"></a></h1></div>
    ...
    <div class="bar">
      ...
      <h2>
      <ol>
        <li><a href="body.php?e=1" id="o">수업내용</a></li>
        <li><a href="body.php?e=2" id="t">공지사항</a></li>
        <li><a href="body.php?e=3" id="th">사진첩</a></li>
